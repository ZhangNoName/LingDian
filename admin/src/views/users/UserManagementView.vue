...
<template>
  <div class="page-stack">
    <div class="page-heading"><div><h1>用户管理</h1><p>统一查看和管理全平台账号、角色与状态。</p></div><el-button type="primary" @click="openCreate">新建用户</el-button></div>
    ...
    <el-alert v-if="error" :title="error" type="error" show-icon :closable="false"><template #default><el-button link type="danger" @click="load">重试</el-button></template></el-alert>
