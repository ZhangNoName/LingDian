...
export const orders: OrderSummary[] = [
  {
    id: "LD202606210001",
    orderNo: "11781519307648606247070",
    orderSource: "MINIAPP",
    pickupCode: "U-0318",
    pickupBusinessDate: "2026-06-21",
  ...
  {
    id: "LD202606150001",
    orderNo: "11781519307648606247069",
    orderSource: "MINIAPP",
    pickupCode: "U-0526",
    pickupBusinessDate: "2026-06-15",
    storeName: "北京市海淀五道口店",
    serviceMode: "dineIn",
    status: "finished",
...
export const orderDetails: Record<string, OrderDetail> = {
  LD202606150001: {
    ...
    infoRows: [
      ...
      { label: "备注", value: "无" },
      { label: "订单类型", value: "堂食" },
      { label: "订单来源", value: "小程序" },
      { label: "取餐日期", value: "2026-06-15" },
      { label: "取餐码", value: "U-0526" },
  ...
  LD202606210001: {
    ...
    infoRows: [
      ...
      { label: "订单类型", value: "堂食" },
      { label: "订单来源", value: "小程序" },
      { label: "取餐日期", value: "2026-06-21" },
      { label: "取餐码", value: "U-0318" },
