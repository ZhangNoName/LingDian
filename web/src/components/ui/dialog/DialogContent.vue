    ...
    >
      ...
      <DialogClose as-child>
        <Button
          variant="ghost"
          size="icon"
          class="absolute right-4 top-4 size-9 rounded-full text-muted-foreground hover:bg-muted"
        >
          <X class="size-4" />
