...
| 文档 | 用途 |
| --- | --- |
| [11-system-structure.md](./11-system-structure.md) | 2026-08-29 系统上下文、部署拓扑、信任边界、数据流和目标模块边界 |
| [12-module-catalog.md](./12-module-catalog.md) | 三端、后端、共享包、CI/运维的逐模块真实状态 |
| [13-permission-and-gap-analysis.md](./13-permission-and-gap-analysis.md) | 当前权限矩阵、P0–P3 风险、目标 RBAC 与上线门禁 |
| [09-architecture-review-2026-08-29.md](./09-architecture-review-2026-08-29.md) | 本轮前期架构、性能、安全与 UI 审查记录 |
...
推荐先读 11，再用 12 查具体模块，最后按 13 排上线与治理工作。
...
- 新增页面、API、权限或数据表时，同步更新 11、12、13 中受影响部分；
